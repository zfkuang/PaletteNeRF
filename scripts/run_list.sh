...
# bash scripts/chair.sh -m nerf
# bash scripts/horns.sh -m nerf
# bash scripts/hotdog.sh -m nerf
# bash scripts/kitchen.sh -m nerf
# bash scripts/lego.sh -m nerf
# bash scripts/materials.sh -m nerf
...
# bash scripts/fern.sh -m extract
# bash scripts/flower.sh -m extract
# bash scripts/bonsai.sh -m extract
# bash scripts/horns.sh -m extract
# bash scripts/kitchen.sh -m extract
...
# bash scripts/hotdog.sh -m palette
