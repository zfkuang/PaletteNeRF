...
if __name__ == '__main__':
    ...
    parser.add_argument("--lambda_sparsity", type=float, default=1e-4, help='weight of sparsity loss')
    ...
    parser.add_argument("--lweight_decay_epoch", type=int, default=50, help='epoch number when lambda weight drops to 0')
    parser.add_argument("--max_freeze_palette_epoch", type=int, default=50, help='number of maximum epoch to freeze palette color')
    parser.add_argument("--smooth_epoch", type=int, default=50, help='number of maximum epoch before add smooth loss')
