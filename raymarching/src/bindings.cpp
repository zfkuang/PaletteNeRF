...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("composite_rays_flex_train_forward", &composite_rays_flex_train_forward, "composite_rays_flex_train_forward (CUDA)");
    m.def("composite_rays_train_backward", &composite_rays_train_backward, "composite_rays_train_backward (CUDA)");
    m.def("composite_rays_flex_train_backward", &composite_rays_flex_train_backward, "composite_rays_flex_train_backward (CUDA)");
    // infer
